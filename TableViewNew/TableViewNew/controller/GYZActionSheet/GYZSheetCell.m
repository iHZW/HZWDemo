...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        self.myLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, kScreenWidth-15*2, 44.5)];
        ...
        self.tableDivLine = [[UIView alloc]initWithFrame:CGRectMake(15, MaxY(self.myLabel), kScreenWidth-30, kLineHeight)];
